...
typedef uint32_t  WORDD;             // 32-bit WORDD, change to "long" for 16-bit machines
...
{
	WORDD a, b, c, d, e, f, g, h, i, j, t1, t2, m[64];
	WORDD S[8];
